...
// The event director needs both the first and last names of each runner for their running bibs.  Combine both the first and last names into a new array 
//called fullName. 
...
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an 
//array named largeShirts that contains information about the runners that have a shirt size of L and log the result
console.log("********************List of Large Size Shirt Runners***************************")
largeShirts = runners.filter(runner => runner.shirt_size === 'L');
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
console.log("********************Adding up all donations***************************")
